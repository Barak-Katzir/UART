...
;# Written by: Amos Zaslavsky (C)copyright - Ver 6.1 #
;#####################################################
puts \n
if {![is_project_open]} {
   puts "========================================"
...
#   set_location_assignment PIN_AB12 -to GPIO0_CLKIN[0]  ;# pin  1
   ...
   ;##################################################################
   ;# JP1 - the right connector (GPIO 1) connected to external board #
   ;##################################################################
...
#   set_location_assignment PIN_R12  -to TX1             ;# pin 28 PC (FTDI) on board
...
#   set_location_assignment PIN_AB9  -to OS              ;# pin 20 ??? on board
#   set_location_assignment PIN_R16  -to GPIO1_CLKOUT[0] ;# pin 19
#   set_location_assignment PIN_V15  -to SCL             ;# pin 18 I2C on board
#   set_location_assignment PIN_W15  -to GPIO1[12]       ;# pin 17
#   set_location_assignment PIN_T15  -to SDA             ;# pin 16 I2C on board
...
# GND                                                    ;# pin 12
# +5 Volt                                                ;# pin 11 
#   set_location_assignment PIN_AB17 -to TRIG            ;# pin 10 Ultrasonic ranger on board
#   set_location_assignment PIN_AA17 -to GPIO1[6]        ;# pin  9
#   set_location_assignment PIN_AA18 -to ECHO            ;# pin  8 Ultrasonic ranger on board
#   set_location_assignment PIN_AB18 -to GPIO1[4]        ;# pin  7
#   set_location_assignment PIN_AB19 -to SP_R            ;# pin  6 Left AUX audio on board
...
#   set_location_assignment PIN_AA20 -to IR              ;# pin  2 IR detector on board
